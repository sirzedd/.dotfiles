...
_G.packer_plugins = {
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
